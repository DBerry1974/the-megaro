...
const HotelsInKingsCrossSurrounding = () => {
  return (
    <div className="hotels-in-kings-cross max-w-7xl mx-auto px-4 py-10 bg-gray-900">
      ...
      <div className="lg:grid lg:grid-cols-4 gap-2">
        {kingsCrosssurroundingareas.map((town, index) => (
          <div key={`towns-${index}`}>
            ...
            <a href={`/hotels-in-kings-cross/${town.toLowerCase().replace(/\s+/g, '-')}`} className="text-gray-900 hover:bg-green-800 hover:text-white block p-2 bg-white">
...
export default HotelsInKingsCrossSurrounding;
